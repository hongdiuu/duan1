            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        ...
                        <span class="h1 text-uppercase text-light bg-primary px-2 ml-n1">Cửa hàng</span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="detail.html" class="nav-item nav-link">Chi tiết cửa hàng</a>
                            ...
                            <a href="contact.html" class="nav-item nav-link">Trang liên hệ</a>
                        </div>
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>Tên</label>
                            <input class="form-control" type="text" placeholder="Vang">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Họ</label>
                            <input class="form-control" type="text" placeholder="Phạm">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Email</label>
                            <input class="form-control" type="text" placeholder="vip@gmail.com">
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6 form-group">
                            <label>Địa chỉ</label>
                            <input class="form-control" type="text" placeholder="Đường 123">
                        </div>
                        <div class="col-md-6 form-group">
            ...
            <div class="col-lg-4">
                ...
                <div class="bg-light p-30 mb-5">
                    ...
                    <div class="border-bottom pt-3 pb-2">
                        ...
                        <div class="d-flex justify-content-between">
                            <h6 class="font-weight-medium">Đang chuyển hàng</h6>
                ...
                <div class="mb-5">
                    <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">SỰ CHI TRẢ</span></h5>
                    <div class="bg-light p-30">
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-4">Sản phẩm chất lượng chăm sóc khách hàng 24/7</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Trịnh Văn Bô, Hà Nội , Việt Nam</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>Vang@gmail.com</p>
