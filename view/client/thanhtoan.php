                          ...
                          <?php
                            ...
                            ?>
                              <div class="panel-default">
                                  <label><input id="payment_defult" type="radio" value="1" name="pttt"> Thanh toán khi nhận hàng
                                </label>
                              </div>
                              <div class="">
                                  <label> <img src="../../upload/payments.png" alt="" >
                                </label>
                              </div>
                              <label class="anh">Thanh toán online sắp ra mắt <style> .anh{background-color: greenyellow;} </style></label>
