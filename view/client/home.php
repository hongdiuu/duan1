    ...
    <main>
            ...
            <div class="slider_area slider_one_area owl-carousel">
                ...
                ?>
                    ...
                    <div class="single_slider d-flex align-items-center" data-bgimg="../../upload/<?= $hinh_anh ?>">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-8 col-md-8 col-sm-7" style="margin-left: 500px;color:white;">
        ...
        <!--banner Màu cam-->
        <div class="banner_fullwidth mb-70" data-bgimg="../../thu_vien/asset/img/bg/offer-1.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="banner-text" style="color:white;">
                            <h3>Thời trang quý phái</h3>
                            <h2>Lịch lãm</h2>
                            <p>Hot nhất mọi thời đại</p>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="instagram_text">
                            <h2>#PinKyStore</h2>
                            <p>Hãy cho chúng tôi biết cách bạn tạo kiểu cho các tác phẩm Hiếm của mình trên Instagram với hashtag #PinKyStore.</p>
                        </div>
                    </div>
                </div>
            </div>
