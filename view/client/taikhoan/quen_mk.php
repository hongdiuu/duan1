            ...
            <div class="col-lg-6 col-md-6">
                <div class="account_form">
                    ...
                    <form action="index.php?act=quen_mk" method="post">
                        ...
                        <div>
                            <input class="dangnhap" style="width: 150px; margin-left: 350px;" type="submit" name="gui"
                                value="Gửi">
                        </div>
                        <?php
                ...
                <div class="account_form register">
                    ...
                    <form action="index.php?act=change_mk" method="POST">
                        ...
                        <div>
                            ...
                            <input style="width: 150px; margin-left: 350px;" class="dangki" type="submit"
                                name="capnhatmk" value="Cập nhập">
